...
app.directive('navigate', ['$route', '$controller', '$location', function ($route, $controller, $location) {
    return {
        restrict: 'A',
        link: function (scope, element, attrs) {
            element.on('click', function () {
                ...
                window.location.href = location.protocol + "//" + location.host + location.pathname + "#" + attrs.navigate;
            });
        }
    };
}]);
